                        ...
                        <div class="col-xl-6 offset-xl-3">
                            ...
                            <form action="{{route('notifications.store')}}" class="mt-3 needs-validations" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="notificationName">
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="inspection_period" class="form-control" id="notificationInspectionPeriod">
                                ...
                                <div class="mb-3 d-flex align-items-center">
                                    ...
                                    <input type="text" name="count_page" class="form-control w-20 mr-2 ml-2" id="notificationInspectionPeriod">
                                ...
                                <div class="mb-3">
                                    <input type="text" name="olx_url" class="form-control hidden" id="olxActiveUrl">
                                    @error('olx_url')
                                    <div class="feedback-error">
                                        {{$message}}
                                    </div>
                                ...
                                <div class="mb-3">
                                    <input type="text" name="fb_url" class="form-control hidden" id="fbActiveUrl">
                                    @error('fb_url')
                                    <div class="feedback-error">
                                        {{$message}}
                                    </div>
